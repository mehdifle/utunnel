...
```
bash <(curl -s https://raw.githubusercontent.com/mehdifle/utunnel/refs/heads/master/install_utunnel.sh --ipv4)
```

🤖 نصب ربات تلگرام مونیتورینگ

```
bash <(curl -s https://raw.githubusercontent.com/mehdifle/utunnel/refs/heads/master/MonitorBotinstall.sh --ipv4)
```
پس از اجرا:
